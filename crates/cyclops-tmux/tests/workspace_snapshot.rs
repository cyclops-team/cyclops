...
//! fan-out `crates/cyclops-workspace/src/sync.rs` performs today
...
//! (never gate; see `crates/cyclops-workspace/tests/baseline.rs`'s
...
/// `crates/cyclops-workspace/tests/baseline.rs`'s rationale for why this
