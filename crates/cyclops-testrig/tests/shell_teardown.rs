//! The shell home of the teardown rule, `demos/lib.sh`, against the same
//! contract this crate holds Rust to.
//!
...
/// The shell home. This crate sits at `<root>/crates/cyclops-testrig`.
fn lib_sh() -> PathBuf {
...
/// Call one function from `demos/lib.sh`, the way `tests/m1_soak.py`
/// does: source the file, then run the named function with its arguments.
