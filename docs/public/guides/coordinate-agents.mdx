...
The terminal wake carries the required two-sentence summary and exact claim
command. It may visually soft-wrap in a narrow pane, but Cyclops does not drop
