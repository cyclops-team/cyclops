...
This directory reserves stable documentation paths for release media. Media is
not release evidence and must never contain tokens, message bodies, private
paths, or unredacted third-party panes.

Planned assets live under [images](images/README.md) and
...
root README mark their intended placements.
