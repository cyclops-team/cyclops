//! Stamp the commit into the UI client so it can compare itself with the daemon.
//! A build outside a git checkout stamps "unknown".
...
fn main() {
    ...
    // ref instead of a nonexistent src/cyclops-ui/.git path.
