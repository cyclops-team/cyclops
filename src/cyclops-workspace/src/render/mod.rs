...
pub use sidebar::{
    messages_content_width, paint_daemon_status, paint_messages, paint_messages_rail,
    paint_messages_resize_feedback, paint_sidebar_filtered, paint_sidebar_rail,
    paint_sidebar_resize_feedback, sidebar_body_bottom, MessagesPaint, MessagesRailCue,
