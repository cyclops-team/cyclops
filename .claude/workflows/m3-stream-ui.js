...
2. themes/dark.toml: the shipped default, matching the usecyclops.dev identity (fetch nothing: derive from the repo README badge voice and standard dark-terminal ergonomics; document the choices in the file header).
